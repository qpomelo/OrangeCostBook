...
//  OrangeCostBook
//
//  Created by QPomelo on 2019/2/21.
...
class TimeExtension {
    ...
    static func date2timestamp(_ date: Date) -> Int64{
        ...
        return timeStamp - TimeExtension.getGMTHourSeconds()
    }
    // Unix Time Stamp 转 Swift Date
    static func timestamp2DateTime(_ timestamp: Int64) -> Date{
        let timeInterval:TimeInterval = TimeInterval.init(timestamp +  TimeExtension.getGMTHourSeconds())
